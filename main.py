...
class Calculator(QMainWindow):
    ...
    def __init__(self):
        ...
        # tarif def  
        self.ui.sum_btn.clicked.connect(self.sum_func)      
        self.ui.sub_btn.clicked.connect(self.sub_func)
        self.ui.mul_btn.clicked.connect(self.mul_func)
        self.ui.division_btn.clicked.connect(self.div_func)
        self.ui.equal_btn.clicked.connect(self.equal_func)
        ...
        self.ui.ac_btn.clicked.connect(self.ac_func)
...
#chand window baraye yek app hast    
app = QApplication([])  
#sakhtan shey az qapplication 
